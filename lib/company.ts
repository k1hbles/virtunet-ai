...
/**
 * Anonymised engagements. Identities are withheld by design; referrals are
 * arranged as conversations progress.
 */
export const outcomes = [
  {
    slug: "ai-physical-security-retail",
    sector: "Retail property",
    service: "AI Physical Security",
    title: "Missing children found in seconds, on the cameras already installed.",
    figure: "~10 sec",
    figureNote: "to locate a child, down from up to 30 minutes",
  },
  {
    slug: "ai-app-development-recycling",
    sector: "Recycling and resource recovery",
    service: "Custom AI Development",
    title: "Application development at half the cost and twice the speed.",
    figure: "50%",
    figureNote: "of the original development spend",
  },
  {
    ...
    figure: "On demand",
    figureNote: "run whenever the environment changes",
  },
  {
    slug: "ai-governance-healthcare",
    sector: "Healthcare",
    service: "AI Governance",
    title: "A governance model that let a health provider say yes to AI.",
    figure: "Board-ready",
    figureNote: "policy, controls and oversight",
  },
  {
    slug: "ai-automation-manufacturing",
    sector: "Manufacturing",
    service: "AI Automation",
    title: "Manual approvals removed from a high-volume production workflow.",
    figure: "Hours back",
    figureNote: "returned to the team each week",
  },
  {
    slug: "ai-roadmap-financial-services",
    sector: "Financial services",
    service: "AI Strategy Day",
    title: "A twelve-month roadmap agreed in a single leadership session.",
    figure: "1 day",
    figureNote: "from scattered priorities to a funded plan",
  },
  {
    slug: "ai-enablement-hotel",
    sector: "Hospitality",
    service: "AI Training & Enablement",
    title: "Copilot adoption that survived past month three.",
    figure: "Sustained",
    figureNote: "adoption, not a launch spike",
  },
  {
    slug: "ai-edge-content-creation-studio",
    sector: "Content creation",
    service: "AI-Ready Devices",
    title: "On-device AI for a studio that could not send work to the cloud.",
    figure: "On device",
    figureNote: "inference, nothing leaves the building",
  },
] as const;
